    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="text-akhir">
                Bahwa yang bersangkutan benar-benar memiliki 3 (tiga) ekor Sapi dengan ciri-ciri sebagai berikut :
            </div>

            <table class="table-hewan" style="width: 100%;">
            ...
            <div class="text-akhir">Demikian surat keterangan ini diberikan kepada yang bersangkutan pada keperluan pengurusan Rekomendasi SKCK dari Polsek Bonepantai</div>
